            ...
            <form action="" method="get">
                ...
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <button onclick="window.location.href='{{ route('brands.index') }}'" class="btn btn-info btn-sm"><i class="fas fa-sync-alt mr-1"></i>Refresh</button>
                    </div>
                </div>
            </form>
            ...
            <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('brands.import_excel') }}" method="POST" enctype="multipart/form-data">
                            @csrf
