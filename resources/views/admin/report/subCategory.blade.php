...
<body>
    ...
    <div class="container">
        ...
        <div class="isi">
            <h2 style="text-align:center;">LAPORAN SUB CATEGORY</h2>
            <table>
            <thead>
                <tr>
                    ...
                    <th style="text-align:center;" class="w-40">Category Name</th>
                    <th style="text-align:center;" class="w-20">Status</th>
                    <th style="text-align:center;" class="w-20">Show On Home</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;">{{$subCategory->showHome}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
