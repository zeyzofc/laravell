    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('products.create') }}" class="btn btn-primary"><i class="fas fa-plus-circle mr-1"></i>New Product</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                    ...
                    <div class="card-title">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="exportDropdownButton">
                                <a href="{{ url('admin/products/export/pdf') }}" class="dropdown-item"><i class="fas fa-file-pdf mr-1"></i>PDF</a>
                                <a href="{{ url('admin/products/export/csv') }}" class="dropdown-item"><i class="fas fa-file-csv mr-1"></i>CSV</a>
