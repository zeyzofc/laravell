                ...
                <div class="card-header">
                    <div class="card-title">
                        <div class="btn-group">
                            ...
                            <a href="{{ url('admin/categories/import/pdf') }}" class="dropdown-item"><i class="fas fa-file-pdf mr-1"></i>PDF</a>
                            <a href="{{ url('admin/categories/import/csv') }}" class="dropdown-item"><i class="fas fa-file-csv mr-1"></i>CSV</a>
                            <a href="{{ url('admin/categories/import/excel') }}" class="dropdown-item"><i class="fas fa-file-excel mr-1"></i>Excel</a>
                            </div>
                        </div>
                        <div class="btn-group">
                        ...
                        <button type="button" onclick="window.location.href='{{ route('categories.index') }}'" class="btn btn-info btn-sm"><i class="fas fa-sync-alt mr-1"></i>Refresh</button>
                        </div>
